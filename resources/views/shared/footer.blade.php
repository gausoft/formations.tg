<div class="m-12">
    ...
    <div class="flex flex-col justify-between mb-8 text-center sm:flex-row">
        ...
        <ul class="flex flex-row justify-center mb-6 -ml-4 -mr-4 text-sm">
            <li>
                <a href="/browse" class="px-4 font-semibold text-black hover:text-primary">Annuaire</a>
            </li>
            <li>
                <a href="/contact" class="px-4 font-semibold text-black hover:text-primary">Contact</a>
            </li>
            <li>
                <a href="/about" class="px-4 font-semibold text-black hover:text-primary">A propos</a>
            </li>
        </ul>
    </div>
</div>